...
# Example usage
text = "RAINBOW COLORS"
live_text(rainbow_text('                This tool is by  #𝐍𝐈𝐊𝐙 | @NikzPy'))
print("\033[1;92m" + "╔═════════════════════════════════════════════════════════╗" )
blue = "\033[1m\033[34m"
green = "\033[1m\033[32m"
WDEH = render('#NIKZ', colors=['yellow', 'green'], align='center')
live_text(WDEH)
print('')                                                               
print("\033[1;92m" + "╚═════════════════════════════════════════════════════════╝" )
try:
...
def pppp():
    os.system('clear')
    output = (f"{cyan}══════════════════════════════════════════════════\n"
              f"      {yellow}⚡ #𝐍𝐈𝐊𝐙 | NikzPy ⚡{cyan}\n"
              f"══════════════════════════════════════════════════\n"
              f"{green}[✔] {white}Valid Hits  : {green}{hits}\n"
              f"{yellow}[➤] {white}Generated   : {yellow}{badinsta}\n"
              f"{red}[✘] {white}Invalid Mails: {red}{bademail}\n"
              f"{red}[❌] {white}Bad Accounts : {red}{goodig}\n"
              f"{cyan}══════════════════════════════════════════════════{reset}\n")
